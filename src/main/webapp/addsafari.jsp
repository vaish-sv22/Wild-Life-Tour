...
<div class="form-container">
    ...
    <form action="SafariAction" method="post">
        ...
        <input type="number" step="0.01" name="price_per_seat" id="price_per_seat" required>

        <label for="description">Description</label>
        <textarea name="description" id="description" rows="4" placeholder="Enter safari description here..."></textarea>
